...
import { Button, CircularProgress, Container, Input, InputLabel, MenuItem, Paper, Select, TextField } from '@mui/material';
    ...
    useEffect(() => { 
        if(!userInfo){
            ...
            if(updateSuccess){
                ...
                history.push('http://localhost:8000/admin/productList/page/1')
            }else{
